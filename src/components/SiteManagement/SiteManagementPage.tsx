 ...
 * Overview and navigation to site management sub-pages
 */
...
export function SiteManagementPage() {
  const managementOptions = [
    {
      title: "All Sites",
      description: "Manage individual site profiles and settings across all business types",
      icon: List,
      action: "View Sites",
      count: 11,
    },
    {
      title: "Groups",
      description: "Organize sites under parent organizations and business chains",
      icon: Users,
      action: "View Groups",
      count: 10,
    },
    {
      ...
      description: "Manage businesses with multiple locations under unified management",
      icon: Globe,
      action: "View Multi-Location",
      count: 10,
    },
  ];
      ...
      <div className="p-10">
        ...
        <div className="mt-10 grid grid-cols-3 gap-6">
          <div className="border border-gray-200 rounded-lg p-6">
            <p className="text-xs text-gray-600 mb-2">Total Sites</p>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            <p className="text-xs text-gray-600 mb-2">Multi-Location Networks</p>
            <p className="text-3xl font-semibold text-gray-900">10</p>
          </div>
        </div>
        ...
        <div className="mt-10 border border-gray-200 rounded-lg p-6">
          <h3 className="text-sm font-medium text-gray-900 mb-2">About Site Management</h3>
          <p className="text-xs text-gray-600 leading-relaxed">
            Organize and manage your business sites through three different structures. Individual sites for
            standalone businesses, groups for affiliated organizations and chains, and multi-location networks for
            businesses operating multiple branches under unified management.
          </p>
        </div>
      </div>
    </div>
